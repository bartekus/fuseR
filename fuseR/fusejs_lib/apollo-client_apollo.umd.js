...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('fusejs_lib/whatwg-fetch_fetch.js'), require('fusejs_lib/graphql_language_printer.js'), require('fusejs_lib/redux.js'), require('fusejs_lib/graphql-anywhere_src.js'), require('fusejs_lib/symbol-observable.js')) : typeof define === 'function' && define.amd ? define(['exports', 'whatwg-fetch', 'graphql/language/printer', 'redux', 'graphql-anywhere', 'symbol-observable'], factory) : factory(global.apollo = global.apollo || {}, null, global.graphql_language_printer, global.redux, global.graphqlAnywhere, global.$$observable);
})(undefined, function (exports, whatwgFetch, graphql_language_printer, redux, graphqlAnywhere, $$observable) {
    'use strict';
    ...
    function writeQueryToStore(_a) {
        ...
        variables = _extends(getDefaultValues(queryDefinition), variables);
    ...
    function writeResultToStore(_a) {
        ...
        variables = _extends(getDefaultValues(operationDefinition), variables);
        return writeSelectionSetToStore({
            result: result,
            dataId: dataId,
    ...
    function writeFieldToStore(_a) {
        ...
        if (!field.selectionSet || value === null) {
            ...
            if (store[dataId] && store[dataId][storeFieldName] !== storeValue) {
                ...
                if (isIdValue(storeValue) && storeValue.generated && isIdValue(escapedId) && !escapedId.generated) {
    ...
    function optimistic(previousState, action, store, config) {
        ...
        if (isMutationInitAction(action) && action.optimisticResponse) {
            ...
            return newState;
        } else if ((isMutationErrorAction(action) || isMutationResultAction(action)) && previousState.some(function (change) {
    ...
    function queries(previousState, action) {
        ...
        if (isQueryInitAction(action)) {
            ...
            if (action.storePreviousVariables && previousQuery && previousQuery.networkStatus !== exports.NetworkStatus.loading) {
    ...
    var ObservableQuery = function (_super) {
        ...
        ObservableQuery.prototype.setOptions = function (opts) {
            ...
            var tryFetch = oldOptions.fetchPolicy !== 'network-only' && opts.fetchPolicy === 'network-only' || oldOptions.fetchPolicy === 'cache-only' && opts.fetchPolicy !== 'cache-only' || false;
        ...
        ObservableQuery.prototype.setVariables = function (variables, tryFetch) {
            ...
            if (isEqual(newVariables, this.variables) && !tryFetch) {
                ...
                return this.queryManager.fetchQuery(this.queryId, __assign$12({}, this.options, { variables: this.variables })).then(function (result) {
                    return maybeDeepFreeze(result);
                });
            }
        };
    ...
    var QueryManager = function () {
        ...
        QueryManager.prototype.mutate = function (_a) {
            ...
            variables = _extends(getDefaultValues(getMutationDefinition(mutation)), variables);
        ...
        QueryManager.prototype.watchQuery = function (options, shouldSubscribe) {
            ...
            if (queryDefinition.variableDefinitions && queryDefinition.variableDefinitions.length) {
                ...
                options.variables = _extends(defaultValues, options.variables);
            }
        ...
        QueryManager.prototype.startGraphQLSubscription = function (options) {
            ...
            var variables = _extends(getDefaultValues(getOperationDefinition(query)), options.variables);
            var request = {
    ...
    var ApolloClient$1 = function () {
        function ApolloClient(options) {
            ...
            this.networkInterface = networkInterface ? networkInterface : createNetworkInterface({ uri: '/graphql' });
            this.addTypename = addTypename;
