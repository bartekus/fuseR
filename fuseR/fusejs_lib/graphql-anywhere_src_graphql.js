...
var getFromAST_1 = require("fusejs_lib/graphql-anywhere_src_getFromAST.js");
var directives_1 = require("fusejs_lib/graphql-anywhere_src_directives.js");
var storeUtils_1 = require("fusejs_lib/graphql-anywhere_src_storeUtils.js");
...
function merge(dest, src) {
    if (src === null || typeof src === 'undefined' || typeof src === 'string' || typeof src === 'number' || typeof src === 'boolean') {
        return src;
    }
